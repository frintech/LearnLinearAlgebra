...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:TextBox ID="TextBox8" runat="server" TextMode="Number" Width="40px">5</asp:TextBox>
    ...
    <asp:Panel ID="Panel3" runat="server" Visible="false">
        ...
        <div class="color-box">
                <div class="shadow">                    
                    <div class="tip-box">
                        <p><strong>Notes:</strong>Please note the Order of matrix</p>
                    </div>
                </div>
            </div>
        ...
        <div class="color-box">
                <div class="shadow">                    
                    <div class="tip-box">
                        <p><strong>Rule:</strong>If Determinant of matrix is not equal to Zero then only we can find Inverse Matrix.</p>
                    </div>
                </div>
            </div>
        <br />
        ...
        <br />
        <p>
            The step is to create a &quot;Matrix of Minors&quot;. This step has the most calculations:
        </p>
        ...
        <table>
            <tr>
                <td>
                    <asp:GridView ID="GridView31" runat="server" ShowHeader="False">
                    </asp:GridView>
                </td>
                <td>
                    <asp:GridView ID="GridView32" runat="server" ShowHeader="False">
                    </asp:GridView>
                </td>
                <td>
                    <asp:GridView ID="GridView33" runat="server" ShowHeader="False">
                    </asp:GridView>
                </td>
            </tr>
        </table>
